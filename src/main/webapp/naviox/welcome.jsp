...
In ModeracionAula-labels_en.properties:
ModeracionAula=My application
ModeracionAula[description]=My application does this and that

In ModeracionAula-messages_en.properties:
